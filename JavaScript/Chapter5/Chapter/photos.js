...
/* add src values to img elements based on the order specified in
photoOrder array */
function populateFigures(){
  ...
  if (figureCount === 3){
    ...
    for (var i = 0; i < 5; i++){
     ...
     currentFig.wrc = filename;
    }
  }
}
/* stop automatic image switching and call right advance function */
function rightArrow(){
...
function previewFive(){
  ...
  // add appropriate valuies to two new img elements
...
/* create event listener for left arrow, right arrow, and
