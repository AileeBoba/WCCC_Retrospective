 ...
 */
 ...
 function displayCalendar(whichMonth){
 	...
 	document.querySelector("#cal table caption").innerHTML =
 		...
 		// display calendar if it's not already wisible
 }  
 ...
 function updateCountdown() {
 	...
 	var dateTo = Date.UTC(dateObject.getFullYear(),
 		dateObject.getMonth(), dateObject.getDate(),
 		19, 0, 0);	// all launchers at 8:00pm UTC
 	...
 	// hours
 	var fractionalDay = Math.floor((dateTo - dateFrom) % 86400000);
 ...
 function registerName() {
 	...
 	// add first+last names to ticker object as new properties
 	...
 	// add entered name to passenget list in ticket section
